...
namespace WebBanSach.Controllers
{
    public class UserController : Controller
    {
        ...
        public void BuildUserTemplate(int khMaKh)
        {
            ...
            var url = "https://webbansach/" + "User/XacNhan?khMaKh="+khMaKh;
        ...
        public static void SendEmail(MailMessage mail)
        {
            ...
            client.Credentials = new System.Net.NetworkCredential("webbansach@gmail.com","webbansach123");
            try
            {
                client.Send(mail);
            }
